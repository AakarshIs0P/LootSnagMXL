...
import { formatPrice, formatStrikePrice, formatDiscount, buildWishlistId } from '../utils/formatter.js';
...
export function buildDealMessage(deal, currency = 'INR', exchangeRate = 84, imageUrl = null) {
  ...
  const addId = buildWishlistId('wl_add', deal.gameId || deal.dealId, deal.title);
  ...
  return {
    components: [
      container(
        ...
        separator(false, 1),
        actionRow(
          linkButton('Open Deal', deal.url, 'deal'),
